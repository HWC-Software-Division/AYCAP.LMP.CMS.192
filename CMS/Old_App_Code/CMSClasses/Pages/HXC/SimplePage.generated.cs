...
[assembly: RegisterDocumentType(SimplePage.CLASS_NAME, typeof(SimplePage))]

namespace CMS.DocumentEngine.Types.HXC
{
	/// <summary>
	/// Represents a content item of type SimplePage.
	/// </summary>
	public partial class SimplePage : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "HXC.SimplePage";


		/// <summary>
		/// The instance of the class that provides extended API for working with SimplePage fields.
		/// </summary>
		private readonly SimplePageFields mFields;
		...
		public int SimplePageID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("SimplePageID"), 0);
			}
			set
			{
				SetValue("SimplePageID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with SimplePage fields.
		/// </summary>
		[RegisterProperty]
		public SimplePageFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with SimplePage fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class SimplePageFields : AbstractHierarchicalObject<SimplePageFields>
		{
			/// <summary>
			/// The content item of type SimplePage that is a target of the extended API.
			/// </summary>
			private readonly SimplePage mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="SimplePageFields" /> class with the specified content item of type SimplePage.
			/// </summary>
			/// <param name="instance">The content item of type SimplePage that is a target of the extended API.</param>
			public SimplePageFields(SimplePage instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.SimplePageID;
				}
				set
				{
					mInstance.SimplePageID = value;
				}
			}
		...
		/// </summary>
		public SimplePage() : base(CLASS_NAME)
		{
			mFields = new SimplePageFields(this);
		}
