...
[assembly: RegisterDocumentType(InsuranceTypePage.CLASS_NAME, typeof(InsuranceTypePage))]

namespace CMS.DocumentEngine.Types.LMP
{
	/// <summary>
	/// Represents a content item of type InsuranceTypePage.
	/// </summary>
	public partial class InsuranceTypePage : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "LMP.InsuranceTypePage";


		/// <summary>
		/// The instance of the class that provides extended API for working with InsuranceTypePage fields.
		/// </summary>
		private readonly InsuranceTypePageFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int InsuranceTypePageID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("InsuranceTypePageID"), 0);
			}
			set
			{
				SetValue("InsuranceTypePageID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with InsuranceTypePage fields.
		/// </summary>
		[RegisterProperty]
		public InsuranceTypePageFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with InsuranceTypePage fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class InsuranceTypePageFields : AbstractHierarchicalObject<InsuranceTypePageFields>
		{
			/// <summary>
			/// The content item of type InsuranceTypePage that is a target of the extended API.
			/// </summary>
			private readonly InsuranceTypePage mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="InsuranceTypePageFields" /> class with the specified content item of type InsuranceTypePage.
			/// </summary>
			/// <param name="instance">The content item of type InsuranceTypePage that is a target of the extended API.</param>
			public InsuranceTypePageFields(InsuranceTypePage instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.InsuranceTypePageID;
				}
				set
				{
					mInstance.InsuranceTypePageID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="InsuranceTypePage" /> class.
		/// </summary>
		public InsuranceTypePage() : base(CLASS_NAME)
		{
			mFields = new InsuranceTypePageFields(this);
		}
