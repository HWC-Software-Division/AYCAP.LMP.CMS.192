...
[assembly: RegisterDocumentType(InsuranceTypeDetailPage.CLASS_NAME, typeof(InsuranceTypeDetailPage))]

namespace CMS.DocumentEngine.Types.LMP
{
	/// <summary>
	/// Represents a content item of type InsuranceTypeDetailPage.
	/// </summary>
	public partial class InsuranceTypeDetailPage : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "LMP.InsuranceTypeDetailPage";


		/// <summary>
		/// The instance of the class that provides extended API for working with InsuranceTypeDetailPage fields.
		/// </summary>
		private readonly InsuranceTypeDetailPageFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int InsuranceTypeDetailPageID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("InsuranceTypeDetailPageID"), 0);
			}
			set
			{
				SetValue("InsuranceTypeDetailPageID", value);
			}
		}
		...
		public string HasBackground
		{
			get
			{
				return ValidationHelper.GetString(GetValue("HasBackground"), @"2");
			}
			set
			{
				SetValue("HasBackground", value);
			}
		}
		...
		public string BackgroundColor
		{
			get
			{
				return ValidationHelper.GetString(GetValue("BackgroundColor"), @"#F6FFFF");
			}
			set
			{
		...
		/// </summary>
		[DatabaseField]
		public string BackgroundImagePc
		{
			get
			{
				return ValidationHelper.GetString(GetValue("BackgroundImagePc"), @"");
			}
			set
			{
				SetValue("BackgroundImagePc", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string BackgroundImageMb
		{
			get
			{
				return ValidationHelper.GetString(GetValue("BackgroundImageMb"), @"");
			}
			set
			{
				SetValue("BackgroundImageMb", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string BackgroundImageAlt
		{
			get
			{
				return ValidationHelper.GetString(GetValue("BackgroundImageAlt"), @"");
			}
			set
			{
				SetValue("BackgroundImageAlt", value);
			}
		}
		...
		public string IconImage
		{
			get
			{
				return ValidationHelper.GetString(GetValue("IconImage"), @"");
			}
			set
			{
		...
		/// </summary>
		[DatabaseField]
		public string IconHoverImage
		{
			get
			{
				return ValidationHelper.GetString(GetValue("IconHoverImage"), @"");
			}
			set
			{
				SetValue("IconHoverImage", value);
			}
		}
		...
		public string IconImageAlt
		{
			get
			{
				return ValidationHelper.GetString(GetValue("IconImageAlt"), @"");
			}
			set
			{
				SetValue("IconImageAlt", value);
			}
		}
		...
		public bool HasBreadCrumb
		{
			get
			{
				return ValidationHelper.GetBoolean(GetValue("HasBreadCrumb"), false);
			}
			set
			{
		...
		/// <summary>
		/// Gets an object that provides extended API for working with InsuranceTypeDetailPage fields.
		/// </summary>
		[RegisterProperty]
		public InsuranceTypeDetailPageFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with InsuranceTypeDetailPage fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class InsuranceTypeDetailPageFields : AbstractHierarchicalObject<InsuranceTypeDetailPageFields>
		{
			/// <summary>
			/// The content item of type InsuranceTypeDetailPage that is a target of the extended API.
			/// </summary>
			private readonly InsuranceTypeDetailPage mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="InsuranceTypeDetailPageFields" /> class with the specified content item of type InsuranceTypeDetailPage.
			/// </summary>
			/// <param name="instance">The content item of type InsuranceTypeDetailPage that is a target of the extended API.</param>
			public InsuranceTypeDetailPageFields(InsuranceTypeDetailPage instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.InsuranceTypeDetailPageID;
				}
				set
				{
					mInstance.InsuranceTypeDetailPageID = value;
				}
			}
			...
			public string HasBackground
			{
				get
				{
					return mInstance.HasBackground;
				}
				set
				{
					mInstance.HasBackground = value;
				}
			}
			...
			public string BackgroundImagePc
			{
				get
				{
					return mInstance.BackgroundImagePc;
				}
				set
				{
					mInstance.BackgroundImagePc = value;
				}
			}
			...
			public string BackgroundImageMb
			{
				get
				{
					return mInstance.BackgroundImageMb;
				}
				set
				{
					mInstance.BackgroundImageMb = value;
				}
			}
			...
			public string BackgroundImageAlt
			{
				get
				{
					return mInstance.BackgroundImageAlt;
				}
				set
				{
					mInstance.BackgroundImageAlt = value;
				}
			}
			...
			public string IconImage
			{
				get
				{
					return mInstance.IconImage;
				}
				set
				{
					mInstance.IconImage = value;
				}
			}
			...
			public string IconHoverImage
			{
				get
				{
					return mInstance.IconHoverImage;
				}
				set
				{
					mInstance.IconHoverImage = value;
				}
			}
			...
			public string IconImageAlt
			{
				get
				{
					return mInstance.IconImageAlt;
				}
				set
				{
					mInstance.IconImageAlt = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="InsuranceTypeDetailPage" /> class.
		/// </summary>
		public InsuranceTypeDetailPage() : base(CLASS_NAME)
		{
			mFields = new InsuranceTypeDetailPageFields(this);
		}
