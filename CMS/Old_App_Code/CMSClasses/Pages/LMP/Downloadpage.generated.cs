...
namespace CMS.DocumentEngine.Types.LMP
{
	...
	public partial class Downloadpage : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "LMP.Downloadpage";
		...
		public string TitlePage
		{
			get
			{
				return ValidationHelper.GetString(GetValue("TitlePage"), @"");
			}
			set
			{
				SetValue("TitlePage", value);
			}
		}
		...
		public string SubTitlePage
		{
			get
			{
				return ValidationHelper.GetString(GetValue("SubTitlePage"), @"");
			}
			set
			{
				SetValue("SubTitlePage", value);
			}
		}
		...
		public string ButtonName
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ButtonName"), @"");
			}
			set
			{
		...
		public string SectionClassName
		{
			get
			{
				return ValidationHelper.GetString(GetValue("SectionClassName"), @"");
			}
			set
			{
				SetValue("SectionClassName", value);
			}
		}
		...
		public partial class DownloadpageFields : AbstractHierarchicalObject<DownloadpageFields>
		{
			...
			public string TitlePage
			{
				get
				{
					return mInstance.TitlePage;
				}
				set
				{
					mInstance.TitlePage = value;
				}
			}
			...
			public string SubTitlePage
			{
				get
				{
					return mInstance.SubTitlePage;
				}
				set
				{
					mInstance.SubTitlePage = value;
				}
			}
			...
			public string ButtonName
			{
				get
				{
					return mInstance.ButtonName;
				}
				set
				{
					mInstance.ButtonName = value;
				}
			}
			...
			public string SectionClassName
			{
				get
				{
					return mInstance.SectionClassName;
				}
				set
				{
					mInstance.SectionClassName = value;
				}
			}
