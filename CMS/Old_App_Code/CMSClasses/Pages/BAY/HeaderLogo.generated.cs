...
[assembly: RegisterDocumentType(HeaderLogo.CLASS_NAME, typeof(HeaderLogo))]

namespace CMS.DocumentEngine.Types.BAY
{
	/// <summary>
	/// Represents a content item of type HeaderLogo.
	/// </summary>
	public partial class HeaderLogo : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "BAY.HeaderLogo";


		/// <summary>
		/// The instance of the class that provides extended API for working with HeaderLogo fields.
		/// </summary>
		private readonly HeaderLogoFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int HeaderLogoID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("HeaderLogoID"), 0);
			}
			set
			{
				SetValue("HeaderLogoID", value);
			}
		}
		...
		public string ImageLogo
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ImageLogo"), @"");
			}
			set
			{
				SetValue("ImageLogo", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string ImageLogoAlt
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ImageLogoAlt"), @"");
			}
			set
			{
				SetValue("ImageLogoAlt", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with HeaderLogo fields.
		/// </summary>
		[RegisterProperty]
		public HeaderLogoFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with HeaderLogo fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class HeaderLogoFields : AbstractHierarchicalObject<HeaderLogoFields>
		{
			/// <summary>
			/// The content item of type HeaderLogo that is a target of the extended API.
			/// </summary>
			private readonly HeaderLogo mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="HeaderLogoFields" /> class with the specified content item of type HeaderLogo.
			/// </summary>
			/// <param name="instance">The content item of type HeaderLogo that is a target of the extended API.</param>
			public HeaderLogoFields(HeaderLogo instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.HeaderLogoID;
				}
				set
				{
					mInstance.HeaderLogoID = value;
				}
			}
			...
			public string ImageLogo
			{
				get
				{
					return mInstance.ImageLogo;
				}
				set
				{
					mInstance.ImageLogo = value;
				}
			}
			...
			public string ImageLogoAlt
			{
				get
				{
					return mInstance.ImageLogoAlt;
				}
				set
				{
					mInstance.ImageLogoAlt = value;
				}
			}
		...
		/// </summary>
		public HeaderLogo() : base(CLASS_NAME)
		{
			mFields = new HeaderLogoFields(this);
		}
