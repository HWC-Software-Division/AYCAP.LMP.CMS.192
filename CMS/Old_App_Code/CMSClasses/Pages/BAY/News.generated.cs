...
namespace CMS.DocumentEngine.Types.BAY
{
	...
	public partial class News : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "BAY.News";
		...
		public string BannerMobile
		{
			get
			{
				return ValidationHelper.GetString(GetValue("BannerMobile"), @"");
			}
			set
			{
				SetValue("BannerMobile", value);
			}
		}
		...
		public string BannerAlt
		{
			get
			{
				return ValidationHelper.GetString(GetValue("BannerAlt"), @"");
			}
			set
			{
				SetValue("BannerAlt", value);
			}
		}
		...
		public partial class NewsFields : AbstractHierarchicalObject<NewsFields>
		{
			...
			public string BannerMobile
			{
				get
				{
					return mInstance.BannerMobile;
				}
				set
				{
					mInstance.BannerMobile = value;
				}
			}
			...
			public string BannerAlt
			{
				get
				{
					return mInstance.BannerAlt;
				}
				set
				{
					mInstance.BannerAlt = value;
				}
			}
