...
[assembly: RegisterDocumentType(ImageBanner360.CLASS_NAME, typeof(ImageBanner360))]

namespace CMS.DocumentEngine.Types.BAY
{
	/// <summary>
	/// Represents a content item of type ImageBanner360.
	/// </summary>
	public partial class ImageBanner360 : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "BAY.ImageBanner360";


		/// <summary>
		/// The instance of the class that provides extended API for working with ImageBanner360 fields.
		/// </summary>
		private readonly ImageBanner360Fields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int ImageBanner360ID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("ImageBanner360ID"), 0);
			}
			set
			{
				SetValue("ImageBanner360ID", value);
			}
		}


		/// <summary>
		/// Image desktop (1920x360).
		/// </summary>
		[DatabaseField]
		...
		/// <summary>
		/// Gets an object that provides extended API for working with ImageBanner360 fields.
		/// </summary>
		[RegisterProperty]
		public ImageBanner360Fields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with ImageBanner360 fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class ImageBanner360Fields : AbstractHierarchicalObject<ImageBanner360Fields>
		{
			/// <summary>
			/// The content item of type ImageBanner360 that is a target of the extended API.
			/// </summary>
			private readonly ImageBanner360 mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="ImageBanner360Fields" /> class with the specified content item of type ImageBanner360.
			/// </summary>
			/// <param name="instance">The content item of type ImageBanner360 that is a target of the extended API.</param>
			public ImageBanner360Fields(ImageBanner360 instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.ImageBanner360ID;
				}
				set
				{
					mInstance.ImageBanner360ID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ImageBanner360" /> class.
		/// </summary>
		public ImageBanner360() : base(CLASS_NAME)
		{
			mFields = new ImageBanner360Fields(this);
		}
