...
[assembly: RegisterDocumentType(BaseContentPage.CLASS_NAME, typeof(BaseContentPage))]

namespace CMS.DocumentEngine.Types.BAY
{
	/// <summary>
	/// Represents a content item of type BaseContentPage.
	/// </summary>
	public partial class BaseContentPage : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "BAY.BaseContentPage";


		/// <summary>
		/// The instance of the class that provides extended API for working with BaseContentPage fields.
		/// </summary>
		private readonly BaseContentPageFields mFields;
		...
		/// <summary>
		/// KrungsriBaseContentPageID.
		/// </summary>
		[DatabaseIDField]
		public int BaseContentPageID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("BaseContentPageID"), 0);
			}
			set
			{
				SetValue("BaseContentPageID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with BaseContentPage fields.
		/// </summary>
		[RegisterProperty]
		public BaseContentPageFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with BaseContentPage fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class BaseContentPageFields : AbstractHierarchicalObject<BaseContentPageFields>
		{
			/// <summary>
			/// The content item of type BaseContentPage that is a target of the extended API.
			/// </summary>
			private readonly BaseContentPage mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="BaseContentPageFields" /> class with the specified content item of type BaseContentPage.
			/// </summary>
			/// <param name="instance">The content item of type BaseContentPage that is a target of the extended API.</param>
			public BaseContentPageFields(BaseContentPage instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.BaseContentPageID;
				}
				set
				{
					mInstance.BaseContentPageID = value;
				}
			}
		...
		/// </summary>
		public BaseContentPage() : base(CLASS_NAME)
		{
			mFields = new BaseContentPageFields(this);
		}
