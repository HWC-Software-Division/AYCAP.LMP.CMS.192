...
[assembly: RegisterDocumentType(ImageBanner320.CLASS_NAME, typeof(ImageBanner320))]

namespace CMS.DocumentEngine.Types.BAY
{
	/// <summary>
	/// Represents a content item of type ImageBanner320.
	/// </summary>
	public partial class ImageBanner320 : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "BAY.ImageBanner320";


		/// <summary>
		/// The instance of the class that provides extended API for working with ImageBanner320 fields.
		/// </summary>
		private readonly ImageBanner320Fields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int ImageBanner320ID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("ImageBanner320ID"), 0);
			}
			set
			{
				SetValue("ImageBanner320ID", value);
			}
		}


		/// <summary>
		/// Image desktop (1920x320).
		/// </summary>
		[DatabaseField]
		...
		/// <summary>
		/// Gets an object that provides extended API for working with ImageBanner320 fields.
		/// </summary>
		[RegisterProperty]
		public ImageBanner320Fields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with ImageBanner320 fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class ImageBanner320Fields : AbstractHierarchicalObject<ImageBanner320Fields>
		{
			/// <summary>
			/// The content item of type ImageBanner320 that is a target of the extended API.
			/// </summary>
			private readonly ImageBanner320 mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="ImageBanner320Fields" /> class with the specified content item of type ImageBanner320.
			/// </summary>
			/// <param name="instance">The content item of type ImageBanner320 that is a target of the extended API.</param>
			public ImageBanner320Fields(ImageBanner320 instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.ImageBanner320ID;
				}
				set
				{
					mInstance.ImageBanner320ID = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ImageBanner320" /> class.
		/// </summary>
		public ImageBanner320() : base(CLASS_NAME)
		{
			mFields = new ImageBanner320Fields(this);
		}
