...
[assembly: RegisterDocumentType(MutualFundProduct.CLASS_NAME, typeof(MutualFundProduct))]

namespace CMS.DocumentEngine.Types.BAY
{
	/// <summary>
	/// Represents a content item of type MutualFundProduct.
	/// </summary>
	public partial class MutualFundProduct : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "BAY.MutualFundProduct";


		/// <summary>
		/// The instance of the class that provides extended API for working with MutualFundProduct fields.
		/// </summary>
		private readonly MutualFundProductFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int MutualFundProductID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("MutualFundProductID"), 0);
			}
			set
			{
				SetValue("MutualFundProductID", value);
			}
		}
		...
		public DateTime ReleaseDate
		{
			get
			{
				return ValidationHelper.GetDateTime(GetValue("ReleaseDate"), DateTimeHelper.ZERO_TIME);
			}
			set
			{
		...
		public string SummaryText
		{
			get
			{
				return ValidationHelper.GetString(GetValue("SummaryText"), @"");
			}
			set
			{
				SetValue("SummaryText", value);
			}
		}
		...
		/// <summary>
		/// Thumbnail desktop (540x300).
		/// </summary>
		[DatabaseField]
		public string ThumbnailDesktop
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ThumbnailDesktop"), @"");
			}
			set
			{
				SetValue("ThumbnailDesktop", value);
			}
		}


		/// <summary>
		/// Thumbnail mobile (770x115).
		/// </summary>
		[DatabaseField]
		public string ThumbnailMobile
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ThumbnailMobile"), @"");
			}
			set
			{
				SetValue("ThumbnailMobile", value);
			}
		}
		...
		public string ThumbnailAlt
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ThumbnailAlt"), @"");
			}
			set
			{
				SetValue("ThumbnailAlt", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with MutualFundProduct fields.
		/// </summary>
		[RegisterProperty]
		public MutualFundProductFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with MutualFundProduct fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class MutualFundProductFields : AbstractHierarchicalObject<MutualFundProductFields>
		{
			/// <summary>
			/// The content item of type MutualFundProduct that is a target of the extended API.
			/// </summary>
			private readonly MutualFundProduct mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="MutualFundProductFields" /> class with the specified content item of type MutualFundProduct.
			/// </summary>
			/// <param name="instance">The content item of type MutualFundProduct that is a target of the extended API.</param>
			public MutualFundProductFields(MutualFundProduct instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.MutualFundProductID;
				}
				set
				{
					mInstance.MutualFundProductID = value;
				}
			}
			...
			public DateTime ReleaseDate
			{
				get
				{
					return mInstance.ReleaseDate;
				}
				set
				{
					mInstance.ReleaseDate = value;
				}
			}
			...
			public string SummaryText
			{
				get
				{
					return mInstance.SummaryText;
				}
				set
				{
					mInstance.SummaryText = value;
				}
			}
			...
			public string ThumbnailDesktop
			{
				get
				{
					return mInstance.ThumbnailDesktop;
				}
				set
				{
					mInstance.ThumbnailDesktop = value;
				}
			}
			...
			public string ThumbnailMobile
			{
				get
				{
					return mInstance.ThumbnailMobile;
				}
				set
				{
					mInstance.ThumbnailMobile = value;
				}
			}
			...
			public string ThumbnailAlt
			{
				get
				{
					return mInstance.ThumbnailAlt;
				}
				set
				{
					mInstance.ThumbnailAlt = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MutualFundProduct" /> class.
		/// </summary>
		public MutualFundProduct() : base(CLASS_NAME)
		{
			mFields = new MutualFundProductFields(this);
		}
