...
[assembly: RegisterDocumentType(Promotion.CLASS_NAME, typeof(Promotion))]

namespace CMS.DocumentEngine.Types.BAY
{
	/// <summary>
	/// Represents a content item of type Promotion.
	/// </summary>
	public partial class Promotion : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "BAY.Promotion";


		/// <summary>
		/// The instance of the class that provides extended API for working with Promotion fields.
		/// </summary>
		private readonly PromotionFields mFields;
		...
		public bool IsHighlight
		{
			get
			{
				return ValidationHelper.GetBoolean(GetValue("IsHighlight"), false);
			}
			set
			{
				SetValue("IsHighlight", value);
			}
		}
		...
		public DateTime PromotionDate
		{
			get
			{
				return ValidationHelper.GetDateTime(GetValue("PromotionDate"), DateTimeHelper.ZERO_TIME);
			}
			set
			{
				SetValue("PromotionDate", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Promotion fields.
		/// </summary>
		[RegisterProperty]
		public PromotionFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Promotion fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class PromotionFields : AbstractHierarchicalObject<PromotionFields>
		{
			/// <summary>
			/// The content item of type Promotion that is a target of the extended API.
			/// </summary>
			private readonly Promotion mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="PromotionFields" /> class with the specified content item of type Promotion.
			/// </summary>
			/// <param name="instance">The content item of type Promotion that is a target of the extended API.</param>
			public PromotionFields(Promotion instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.PromotionID;
				}
				set
				{
					mInstance.PromotionID = value;
				}
			}
			...
			public bool IsHighlight
			{
				get
				{
					return mInstance.IsHighlight;
				}
				set
				{
					mInstance.IsHighlight = value;
				}
			}
			...
			public DateTime Date
			{
				get
				{
					return mInstance.PromotionDate;
				}
				set
				{
					mInstance.PromotionDate = value;
				}
			}
		...
		/// </summary>
		public Promotion() : base(CLASS_NAME)
		{
			mFields = new PromotionFields(this);
		}
