...
using CMS.DocumentEngine.Types.Contenthub;

[assembly: RegisterDocumentType(ArticleCategory.CLASS_NAME, typeof(ArticleCategory))]

namespace CMS.DocumentEngine.Types.Contenthub
{
	/// <summary>
	/// Represents a content item of type ArticleCategory.
	/// </summary>
	public partial class ArticleCategory : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Contenthub.ArticleCategory";


		/// <summary>
		/// The instance of the class that provides extended API for working with ArticleCategory fields.
		/// </summary>
		private readonly ArticleCategoryFields mFields;
		...
		/// <summary>
		/// Gets an object that provides extended API for working with ArticleCategory fields.
		/// </summary>
		[RegisterProperty]
		public ArticleCategoryFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with ArticleCategory fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class ArticleCategoryFields : AbstractHierarchicalObject<ArticleCategoryFields>
		{
			/// <summary>
			/// The content item of type ArticleCategory that is a target of the extended API.
			/// </summary>
			private readonly ArticleCategory mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="ArticleCategoryFields" /> class with the specified content item of type ArticleCategory.
			/// </summary>
			/// <param name="instance">The content item of type ArticleCategory that is a target of the extended API.</param>
			public ArticleCategoryFields(ArticleCategory instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.ArticleCategoryID;
				}
				set
				{
					mInstance.ArticleCategoryID = value;
				}
			}
		...
		/// </summary>
		public ArticleCategory() : base(CLASS_NAME)
		{
			mFields = new ArticleCategoryFields(this);
		}
