...
[assembly: RegisterDocumentType(Guru.CLASS_NAME, typeof(Guru))]

namespace CMS.DocumentEngine.Types.Plearn
{
	/// <summary>
	/// Represents a content item of type Guru.
	/// </summary>
	public partial class Guru : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Plearn.Guru";


		/// <summary>
		/// The instance of the class that provides extended API for working with Guru fields.
		/// </summary>
		private readonly GuruFields mFields;
		...
		public int GuruID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("GuruID"), 0);
			}
			set
			{
				SetValue("GuruID", value);
			}
		}
		...
		public string Guru1
		{
			get
			{
				return ValidationHelper.GetString(GetValue("Guru"), @"");
			}
			set
			{
				SetValue("Guru", value);
		...
		/// </summary>
		[DatabaseField]
		public string GuruDetail
		{
			get
			{
				return ValidationHelper.GetString(GetValue("GuruDetail"), @"");
			}
			set
			{
				SetValue("GuruDetail", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string GuruRemark
		{
			get
			{
				return ValidationHelper.GetString(GetValue("GuruRemark"), @"");
			}
			set
			{
				SetValue("GuruRemark", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Guru fields.
		/// </summary>
		[RegisterProperty]
		public GuruFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Guru fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class GuruFields : AbstractHierarchicalObject<GuruFields>
		{
			/// <summary>
			/// The content item of type Guru that is a target of the extended API.
			/// </summary>
			private readonly Guru mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="GuruFields" /> class with the specified content item of type Guru.
			/// </summary>
			/// <param name="instance">The content item of type Guru that is a target of the extended API.</param>
			public GuruFields(Guru instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.GuruID;
				}
				set
				{
					mInstance.GuruID = value;
				}
			}
			...
			public string Guru
			{
				get
				{
					return mInstance.Guru1;
				}
				set
				{
					mInstance.Guru1 = value;
				}
			}
			...
			public string Detail
			{
				get
				{
					return mInstance.GuruDetail;
				}
				set
				{
					mInstance.GuruDetail = value;
				}
			}
			...
			public string Remark
			{
				get
				{
					return mInstance.GuruRemark;
				}
				set
				{
					mInstance.GuruRemark = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Guru" /> class.
		/// </summary>
		public Guru() : base(CLASS_NAME)
		{
			mFields = new GuruFields(this);
		}
