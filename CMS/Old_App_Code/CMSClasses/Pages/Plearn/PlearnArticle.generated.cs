...
[assembly: RegisterDocumentType(PlearnArticle.CLASS_NAME, typeof(PlearnArticle))]

namespace CMS.DocumentEngine.Types.Plearn
{
	/// <summary>
	/// Represents a content item of type PlearnArticle.
	/// </summary>
	public partial class PlearnArticle : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Plearn.PlearnArticle";


		/// <summary>
		/// The instance of the class that provides extended API for working with PlearnArticle fields.
		/// </summary>
		private readonly PlearnArticleFields mFields;
		...
		public DateTime PostDate
		{
			get
			{
				return ValidationHelper.GetDateTime(GetValue("PostDate"), DateTimeHelper.ZERO_TIME);
			}
			set
			{
				SetValue("PostDate", value);
			}
		}
		...
		public string ArticleBody
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ArticleBody"), @"");
			}
			set
			{
		...
		public string UrlCredit
		{
			get
			{
				return ValidationHelper.GetString(GetValue("UrlCredit"), @"");
			}
			set
			{
				SetValue("UrlCredit", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public decimal ReadTime
		{
			get
			{
				return ValidationHelper.GetDecimal(GetValue("ReadTime"), 0);
			}
			set
			{
				SetValue("ReadTime", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string PictureTop
		{
			get
			{
				return ValidationHelper.GetString(GetValue("PictureTop"), @"");
			}
			set
			{
				SetValue("PictureTop", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string PictureMobile
		{
			get
			{
				return ValidationHelper.GetString(GetValue("PictureMobile"), @"");
			}
			set
			{
				SetValue("PictureMobile", value);
			}
		}
		...
		public string PictureAlt
		{
			get
			{
				return ValidationHelper.GetString(GetValue("PictureAlt"), @"");
			}
			set
			{
				SetValue("PictureAlt", value);
			}
		}
		...
		public string PictureThumbnail
		{
			get
			{
				return ValidationHelper.GetString(GetValue("PictureThumbnail"), @"");
			}
			set
			{
				SetValue("PictureThumbnail", value);
			}
		}
		...
		/// </summary>
		[DatabaseField]
		public string PictureThumbnailAlt
		{
			get
			{
				return ValidationHelper.GetString(GetValue("PictureThumbnailAlt"), @"");
			}
			set
			{
				SetValue("PictureThumbnailAlt", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with PlearnArticle fields.
		/// </summary>
		[RegisterProperty]
		public PlearnArticleFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with PlearnArticle fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class PlearnArticleFields : AbstractHierarchicalObject<PlearnArticleFields>
		{
			/// <summary>
			/// The content item of type PlearnArticle that is a target of the extended API.
			/// </summary>
			private readonly PlearnArticle mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="PlearnArticleFields" /> class with the specified content item of type PlearnArticle.
			/// </summary>
			/// <param name="instance">The content item of type PlearnArticle that is a target of the extended API.</param>
			public PlearnArticleFields(PlearnArticle instance)
			{
				mInstance = instance;
			}
			...
			public DateTime PostDate
			{
				get
				{
					return mInstance.PostDate;
				}
				set
				{
					mInstance.PostDate = value;
				}
			}
			...
			public string ArticleBody
			{
				get
				{
					return mInstance.ArticleBody;
				}
				set
				{
					mInstance.ArticleBody = value;
				}
			}
			...
			public string UrlCredit
			{
				get
				{
					return mInstance.UrlCredit;
				}
				set
				{
					mInstance.UrlCredit = value;
				}
			}
			...
			public decimal ReadTime
			{
				get
				{
					return mInstance.ReadTime;
				}
				set
				{
					mInstance.ReadTime = value;
				}
			}
			...
			public string PictureTop
			{
				get
				{
					return mInstance.PictureTop;
				}
				set
				{
					mInstance.PictureTop = value;
				}
			}
			...
			public string PictureMobile
			{
				get
				{
					return mInstance.PictureMobile;
				}
				set
				{
					mInstance.PictureMobile = value;
				}
			}
			...
			public string PictureAlt
			{
				get
				{
					return mInstance.PictureAlt;
				}
				set
				{
					mInstance.PictureAlt = value;
				}
			}
			...
			public string PictureThumbnail
			{
				get
				{
					return mInstance.PictureThumbnail;
				}
				set
				{
					mInstance.PictureThumbnail = value;
				}
			}
			...
			public string PictureThumbnailAlt
			{
				get
				{
					return mInstance.PictureThumbnailAlt;
				}
				set
				{
					mInstance.PictureThumbnailAlt = value;
				}
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PlearnArticle" /> class.
		/// </summary>
		public PlearnArticle() : base(CLASS_NAME)
		{
			mFields = new PlearnArticleFields(this);
		}
